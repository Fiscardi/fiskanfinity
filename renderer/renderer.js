  ...
  list.innerHTML = actions.map(a => `
    <div class="action-card" data-action-id="${a.id}">
      ...
      <details class="field-group" style="margin:8px 0; border:1px solid rgba(255,255,255,0.1); border-radius:6px; padding:4px 10px;">
        ...
        <div class="field-row"><span>GTA: Lluvia de vehículos - duración en segundos (0 = no activar)</span><input type="number" step="1" min="0" value="${a.gtaCarRainSeconds || 0}" data-a-field="gtaCarRainSeconds" placeholder="10" /></div>
